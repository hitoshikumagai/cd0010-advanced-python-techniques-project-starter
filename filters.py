...
class AttributeFilter:
    ...
    def apply(self, approach):
        """Apply this filter to an approach.
        
        This is an alias for __call__ to maintain compatibility with the database query interface.
        """
        return self.__call__(approach)
